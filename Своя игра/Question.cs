...
namespace Своя_игра
{
    public partial class Question : Form
    {
        ...
        public Question(int a, string[,] names, int[] cheked, int b)
        {
            ...
            text[3, 0] = "Кто такой QA-инженер?"; // 100
            text[3, 1] = "К какой расе принадлежит Марк Цукерберг?"; // 200
            text[3, 2] = "Как называют шуточный секрет, заложенный создателями в ПО?"; // 300
            text[3, 3] = "Назовите самую знаменитую игру, которую создал программист Алексей Пажитнов"; // 400
            text[3, 4] = "Чем известен программист Линус Торвалдс? "; // 500
